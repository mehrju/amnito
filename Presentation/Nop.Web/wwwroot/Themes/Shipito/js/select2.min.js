    ...
    var b = function () {
        ...
        return function () {
            ...
            return b.Extend(c, b.Observable), c.prototype.render = function () {
                ...
                null == f ? c.iranSans.display = "none" : "string" == typeof f ? c.innerHTML = e(f) : a(c).append(f)
            }, c
            ...
            return {
                errorLoading: function () {
                    return "درحال حاضر نتیجه جستجو در دسترس نیست"
                }, inputTooLong: function (a) {
                    var b = a.input.length - a.maximum, c = "Please delete " + b + " character";
                    return 1 != b && (c += "s"), c
                }, inputTooShort: function (a) {
                    return "لطفا " + (a.minimum - a.input.length) + " کاراکتر یا بیشتر وارد کنید"
                }, loadingMore: function () {
                    return "بارگذاری موارد بیشتر…"
            ...
            return c.Extend(e, c.Observable), e.prototype._generateId = function (a) {
                ...
                if ("resolve" == b) {
                    var d = this._resolveWidth(a, "iranSans.css");
