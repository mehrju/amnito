...
{
    public class OrderRefundStatusObjectContext : DbContext, IDbContext
    {
        #region Ctor

        public OrderRefundStatusObjectContext(string nameOrConnectionString)
        ...
        {
            modelBuilder.Configurations.Add(new OrderRefundStatusMap());
        ...
        {
            //drop the table
            var tableName = this.GetTableName<OrderRefundStatus>();
