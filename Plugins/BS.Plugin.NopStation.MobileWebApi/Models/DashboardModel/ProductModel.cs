  ...
  [Serializable]
    public partial class ProductModel : BaseNopEntityModel
    {
        public ProductModel()
        {
            ...
            ProductAttributeCombinations = new List<ProductAttributeCombination>();
            TierPrices = new List<TierPrice>();
            AppliedDiscounts = new List<Discount>();
            ProductWarehouseInventory = new List<ProductWarehouseInventory>();
    }
    ...
    public int ProductTypeId { get; set; }
        ...
        /// </summary>
        public virtual IList<ProductSpecificationAttribute> ProductSpecificationAttributes { get; set; }
        ...
        /// </summary>
        public virtual IList<TierPrice> TierPrices { get; set; }
       
        /// <summary>
        /// Gets or sets the collection of applied discounts
        /// </summary>
        public virtual IList<Discount> AppliedDiscounts { get; set; }
        ...
        /// </summary>
        public virtual IList<ProductWarehouseInventory> ProductWarehouseInventory { get; set; }
