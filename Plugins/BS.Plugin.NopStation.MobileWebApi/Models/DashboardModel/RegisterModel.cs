...
namespace BS.Plugin.NopStation.MobileWebApi.Models.DashboardModel
{
    public partial class RegisterModel : BaseNopModel
    {
        ...
        {
            this.AvailableTimeZones = new List<Model.SelectListItem>();
            this.AvailableCountries = new List<Model.SelectListItem>();
            this.AvailableStates = new List<Model.SelectListItem>();
        ...
        public IList<Model.SelectListItem> AvailableCountries { get; set; }

        public bool StateProvinceEnabled { get; set; }
        public bool StateProvinceRequired { get; set; }
        [NopResourceDisplayName("Account.Fields.StateProvince")]
        public int StateProvinceId { get; set; }
        public IList<Model.SelectListItem> AvailableStates { get; set; }
        ...
        public IList<Model.SelectListItem> AvailableTimeZones { get; set; }
