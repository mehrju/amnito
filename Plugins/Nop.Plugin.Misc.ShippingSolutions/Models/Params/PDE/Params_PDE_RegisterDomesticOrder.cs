...
namespace Nop.Plugin.Misc.ShippingSolutions.Models.Params.PDE
{
    ...
    /// <para>OrigId آیدی  مبدا</para>
    /// <para>DesId آیدی  مقصد</para>
    ...
    /// <para>ClientId =  23553  در تنظیمات وارد شود شماره مشتری مختص شرکت پست بار</para> 
    /// <para> SystemType=1 داخلی</para>
    /// </summary>




    public class Params_PDE_RegisterDomesticOrder
    {
        ...
        public (bool, string) IsValid_PDE_RegisterDomesticOrder()
        {
            bool result = true;
            string Message = "";
            //if (Length <= 0)
