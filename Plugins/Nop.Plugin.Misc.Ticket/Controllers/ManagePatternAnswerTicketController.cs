...
{
    public class ManagePatternAnswerTicketController : BaseAdminController
    {
        ...
        public ManagePatternAnswerTicketController
            (
        ...
        public virtual IActionResult List()
        {
            ...
            return View("/Plugins/Misc.Ticket/Views/PatternAnswerTicket/List.cshtml");
        }
        [HttpPost]
        public virtual IActionResult PatternAnswerList(DataSourceRequest command, Search_PatternAnswerTicket model)
        {
            ...
            try
            {
                pros = _repositoryTbl_PatternAnswer_Ticket_Damages_RequestCOD.Table.Where(p => p.Type == 1).ToList();
                if (pros.Count > 0)
                {
        ...
        public virtual IActionResult Create()
        {
            ...
            return View("/Plugins/Misc.Ticket/Views/PatternAnswerTicket/Create.cshtml");
        }
        ...
        public virtual IActionResult Edit(int id)
        {
            ...
            if (Priority == null || Priority.IsActive == false)
                ...
                return RedirectToAction("List");
            var model = Priority;
            return View("/Plugins/Misc.Ticket/Views/PatternAnswerTicket/Edit.cshtml", model);
        }
