...
{
    public class ManagePatternAnswerRequestCODController : BaseAdminController
    {
        ...
        public ManagePatternAnswerRequestCODController
            (
        ...
        public virtual IActionResult List()
        {
            ...
            return View("/Plugins/Misc.Ticket/Views/PatternAnswerRequestCOD/List.cshtml");
        }
        [HttpPost]
        public virtual IActionResult PatternAnswerList(DataSourceRequest command, Search_PatternAnswerTicket model)
        {
            ...
            try
            {
                pros = _repositoryTbl_PatternAnswer_Ticket_Damages_RequestCOD.Table.Where(p=>p.Type==3).ToList();
                if (pros.Count > 0)
                {
        ...
        public virtual IActionResult Disable(int id)
        {
            ...
            try
            {
                ...
                //activity log
                _customerActivityService.InsertActivity("DisablePatternAnswerTicket", _localizationService.GetResource("Nop.Plugin.Misc.Ticket.MessageDisable"), Dep.TitlePatternAnswer);
        ...
        public virtual IActionResult DisableSelected(ICollection<int> selectedIds)
        {
            ...
            try
            {
                ...
                _customerActivityService.InsertActivity("DisablePatternAnswerTicket", _localizationService.GetResource("Nop.Plugin.Misc.Ticket.MessageDisable"));
                SuccessNotification(_localizationService.GetResource("Nop.Plugin.Misc.Ticket.MessageDisable"));
            }
            catch (Exception ex)
            {
        ...
        public virtual IActionResult Active(int id)
        {
            ...
            try
            {
                ...
                //activity log
                _customerActivityService.InsertActivity("ActivePatternAnswerTicket", _localizationService.GetResource("Nop.Plugin.Misc.Ticket.MessageActive"), Pro.TitlePatternAnswer);
        ...
        public virtual IActionResult ActiveSelected(ICollection<int> selectedIds)
        {
            ...
            try
            {
                ...
                _customerActivityService.InsertActivity("ActivePatternAnswerTicket", _localizationService.GetResource("Nop.Plugin.Misc.Ticket.MessageActive"));
                SuccessNotification(_localizationService.GetResource("Nop.Plugin.Misc.Ticket.MessageActive"));
        ...
        public virtual IActionResult Create()
        {
            ...
            return View("/Plugins/Misc.Ticket/Views/PatternAnswerRequestCOD/Create.cshtml");
        }
        ...
        public virtual IActionResult Create(Tbl_PatternAnswer_Ticket_Damages_RequestCOD model, bool continueEditing)
        {
            ...
            Tbl_PatternAnswer_Ticket_Damages_RequestCOD duplicate = _repositoryTbl_PatternAnswer_Ticket_Damages_RequestCOD.Table.Where(p => p.TitlePatternAnswer == model.TitlePatternAnswer && p.IsActive  && p.Type==1).FirstOrDefault();
            if (duplicate != null)
            {
        ...
        public virtual IActionResult Edit(int id)
        {
            ...
            if (Priority == null || Priority.IsActive == false)
                ...
                return RedirectToAction("List");
            var model = Priority;
            return View("/Plugins/Misc.Ticket/Views/PatternAnswerRequestCOD/Edit.cshtml", model);
        }
        ...
        public virtual IActionResult Edit(Tbl_PatternAnswer_Ticket_Damages_RequestCOD model, bool continueEditing)
        {
            ...
            _repositoryTbl_PatternAnswer_Ticket_Damages_RequestCOD.Update(Priority);
            //activity log
            _customerActivityService.InsertActivity("EditPatternAnswerTicket", _localizationService.GetResource("Nop.Plugin.Misc.Ticket.MessageUpdate"), Priority.TitlePatternAnswer);
