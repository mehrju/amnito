...
{
    [ViewComponent(Name = "Mus_OrderSummaryShipmentConfirm")]
    public class Mus_OrderSummaryShipmentConfirmViewComponent : NopViewComponent
    {
        private readonly IShoppingCartModelFactory _shoppingCartModelFactory;
        private readonly IStoreContext _storeContext;
        private readonly IWorkContext _workContext;

        public Mus_OrderSummaryShipmentConfirmViewComponent(IShoppingCartModelFactory shoppingCartModelFactory,
        ...
        public IViewComponentResult Invoke(bool? prepareAndDisplayOrderReviewData, ShoppingCartModel overriddenModel)
        {
            ...
            return View("~/Plugins/Orders.MultiShipping/Views/Components/OrderSummaryShipmentConfirm/Default.cshtml", newModel);
        }
    }
}
