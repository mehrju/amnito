...
{
    [ViewComponent(Name = "Mus_OrderSummaryShippingMethod")]
    public class Mus_OrderSummaryShippingMethodViewComponent : NopViewComponent
    {
        private readonly IShoppingCartModelFactory _shoppingCartModelFactory;
        private readonly IStoreContext _storeContext;
        private readonly IWorkContext _workContext;

        public Mus_OrderSummaryShippingMethodViewComponent(IShoppingCartModelFactory shoppingCartModelFactory,
        ...
        public IViewComponentResult Invoke(bool? prepareAndDisplayOrderReviewData, ShoppingCartModel overriddenModel)
        {
            ...
            return View("~/Plugins/Orders.MultiShipping/Views/Components/OrderSummaryShippingMethod/Default.cshtml",newModel);
        }
