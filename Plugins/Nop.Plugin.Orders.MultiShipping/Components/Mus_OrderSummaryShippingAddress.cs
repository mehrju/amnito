...
{
    [ViewComponent(Name = "Mus_OrderSummaryShippingAddress")]
    public class Mus_OrderSummaryShippingAddressViewComponent : NopViewComponent
    {
        private readonly IShoppingCartModelFactory _shoppingCartModelFactory;
        private readonly IStoreContext _storeContext;
        private readonly IWorkContext _workContext;

        public Mus_OrderSummaryShippingAddressViewComponent(IShoppingCartModelFactory shoppingCartModelFactory,
        ...
        public IViewComponentResult Invoke(bool? prepareAndDisplayOrderReviewData, ShoppingCartModel overriddenModel)
        {
            ...
            return View("~/Plugins/Orders.MultiShipping/Views/Components/OrderSummaryShippingAddress/Default.cshtml",newModel);
        }
    }
}
