...
<div class="popover mds-bootstrap-persian-datetime-picker-popover" style="width: 97% !impoertant;" role="tooltip" ${mdDatePickerPopoverFlag}>    
    <div class="arrow"></div>    
...
<div class="mds-bootstrap-persian-datetime-picker-container {{rtlCssClass}}" ${mdDatePickerContainerFlag}>
    ...
    <table class="table table-sm text-center p-0 m-0">
        ...
        <tfoot>
                ...
                <td colspan="100" class="border-0">
                    <table class="table table-sm table-borderless">
                        <tbody>
                            <tr>
                                <td>
                                    <input type="text" title="{{hourText}}" value="{{hour}}" maxlength="2" oninput="validateDateInput(this)" data-clock="hour" />
                                </td>
                                <td>:</td>
                                <td>
                                    <input type="text" title="{{minuteText}}" value="{{minute}}" maxlength="2" oninput="validateDateInput(this)" data-clock="minute" />
                                </td>
                                <td>:</td>
                                <td>
                                    <input type="text" title="{{secondText}}" value="{{second}}" maxlength="2" oninput="validateDateInput(this)" data-clock="second" />
                                </td>
                            </tr>
                        </tbody>
                    </table>
            ...
            <tr>
                <td colspan="100">
                    <button type="button" class="btn " title="{{goTodayText}}" data-go-today>{{todayDateString}}</button>
                </td>
            </tr>
        </tfoot>
    </table>
				...
				<th colspan="100" class="border-0">
					<table class="table table-sm table-borderless">
						<thead>
							<tr>
								<th>
									<button type="button" class="btn "> {{currentMonthInfo}} </button>
								</th>
							</tr>
						</thead>
					</table>
			...
			<tr {{theadSelectDateButtonTrAttribute}}>
                <td colspan="100" class="border-0">
                    <table class="table table-sm table-borderless">
                        <tr>
                            <th>
                                <button type="button" class="btn  btn-sm" title="{{previousYearText}}" data-changedatebutton data-number="{{previousYearButtonDateNumber}}" {{previousYearButtonDisabledAttribute}}><i class="fa fa-angle-double-right" aria-hidden="true" style="top: 0px !important"></i></button>
                            </th>
                            <th>
                                <button type="button" class="btn  btn-sm" title="{{previousMonthText}}" data-changedatebutton data-number="{{previousMonthButtonDateNumber}}" {{previousMonthButtonDisabledAttribute}}><i class="fa fa-arrow-circle-o-right" aria-hidden="true" style="top: 0px !important"></i> </button>
                            </th>
                            <th style="width: 120px;">
                                <div class="dropdown">
                                    <button type="button" class="btn  btn-sm dropdown-toggle" id="mdsBootstrapPersianDatetimePickerMonthSelectorButon"
                            ...
                            <th style="width: 50px;">
                                <button type="button" class="btn  btn-sm" select-year-button {{selectYearButtonDisabledAttribute}}>{{selectedYear}}</button>
                            </th>
                            <th>
                                <button type="button" class="btn  btn-sm" title="{{nextMonthText}}" data-changedatebutton data-number="{{nextMonthButtonDateNumber}}" {{nextMonthButtonDisabledAttribute}}> <i class="fa fa-arrow-circle-o-left" aria-hidden="true" style="top: 0px !important"></i> </button>
                            </th>
                            <th>
                                <button type="button" class="btn  btn-sm" title="{{nextYearText}}" data-changedatebutton data-number="{{nextYearButtonDateNumber}}" {{nextYearButtonDisabledAttribute}}> <i class="fa fa-angle-double-left" aria-hidden="true" style="top: 0px !important"></i> </button>
                            </th>
                        </tr>
                    </table>
                </td>
...
<td class="text-center" ${selectedDateTimeToShowJson.year == i ? 'selected-year' : ''}>
    <button class="btn btn-sm " type="button" data-changedatebutton data-number="${yearDateNumber}" ${currentYearDisabledAttr}>${yearText}</button>        
</td>
`;
