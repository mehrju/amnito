...
var newCheckout = function (options) {
    ...
    this.construct = function (options) {
        ...
        $('#btn_SaveNext').click(function () {
            ...
            else checkOutModelList[0].discountCouponCode = null;

            if (checkOutModelList[0].ServiceId == 717 || checkOutModelList[0].ServiceId == 718) {
        ...
        //====================================Wizard========================================================================
        currentMap = new createPostMap(false);//options.IsForegin);
        ...
        var wizard = $('#wizard').steps({
            ...
            onStepChanged: function (event, currentIndex, priorIndex) {
                ...
                if (currentIndex == 2) {
                    ...
                    var _serviceId = $('#tblServiceInfo').find('input[type=radio]:checked').attr('data-val');
                    var CollectorServiceId = [717, 701];//, 718
                    if (CollectorServiceId.indexOf(parseInt(_serviceId)) >= 0) {
                        $("#wizard").steps("finish");
                    }
                }
...
//it will be over ride in bulkorder2.js
function onSave() {
