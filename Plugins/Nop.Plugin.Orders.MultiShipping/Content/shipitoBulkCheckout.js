...
var newCheckout = function (options) {
    ...
    this.construct = function (options) {
        ...
        $('#btn_SaveNext').click(function () {
            ...
            if (msg) {
                alert('اعتبار سنجی اطلاعات ورودی');
                ...
                success: function (data) {
                    ...
                    $('#ServiceId').change(function () {
                        if ($(this).val() == 654 && parseInt($('#Weight_g').val().replace(/,/g, '')) > 5000) {
                            ...
                            alert('برای مرسوله با وزن بیشتر از 5000 گرم(5 کیلوگرم) فقط امکان ثبت سفارش با سرویس پیشتاز وجود دارد');
                            return false;
                        }
                    });
                },
        ...
        $('#RequestPrintAvatar').click(function () {
            ...
            if ($(this).is(':checked')) {
                ...
                if (avatarStatus == 3)
                    ...
                    alert('برای استفاده از این قابلیت می بایست در قسمت حساب من نسبت به آپلود لوگوی تجاری خود اقدام کنید');
                    return;
                }
            }
    ...
    function validateStepItem(currentIndex, newIndex) {
        ...
        if (currentIndex == 2 && newIndex == 3) {
            ...
            //if (msg) {
            //    alert('اعتبار سنجی اطلاعات ورودی', msg, '3');
            //     $('.ajax-loading-block-window').hide();
            //    return false;
            //}
        }
