...
{
    public class SepSuccessOrderController : Web.Controllers.CheckoutController
    {
        ...
        public override IActionResult Completed(int? orderId)
        {
            ...
            if (_workContext.CurrentCustomer.IsGuest() && !_orderSettings.AnonymousCheckoutAllowed)
                return Content("مجداد برنامه را اجرا کنید");
            ...
            return View("~/Plugins/Orders.MultiShipping/Views/NewCheckout/Sep/successOrder.cshtml", model);
        }
    }
}
