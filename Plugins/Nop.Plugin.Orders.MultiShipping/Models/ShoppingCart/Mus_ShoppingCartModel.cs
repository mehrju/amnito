...
namespace Nop.Plugin.Orders.MultiShipping.Models.ShoppingCart
{
    public class Mus_ShoppingCartModel : BaseNopModel
    {
        public Mus_ShoppingCartModel()
        {
        ...
        public partial class ShoppingCartItemModel : BaseNopEntityModel
        {
            ...
            public IList<string> Warnings { get; set; }
            public string PackProductSeName { get; internal set; }
            public decimal Weight { get; internal set; }
            public string WeightOz => Weight > 0 ? $"{(Weight * 16):0.#####} oz" : "";
        }
