...
{
    public partial class ApDashboardController : BasePublicController
    {
        #region Fields
        ...
        public virtual IActionResult Dashboard()
        {
            ...
            return View("~/Plugins/Nop.Plugin.Misc.PostbarDashboard/Views/Ap/Dashboard.cshtml", model);
        }


        public virtual IActionResult Wallet()
        {
            return View("~/Plugins/Nop.Plugin.Misc.PostbarDashboard/Views/Ap/Wallet.cshtml");
        }
        ...
        public virtual IActionResult WalletPaged(int pageIndex, int pageSize)
        {
            ...
            return View("~/Plugins/Nop.Plugin.Misc.PostbarDashboard/Views/Ap/_WalletPaged.cshtml", rewards);
        }


        public virtual IActionResult Orders()
        {
            return View("~/Plugins/Nop.Plugin.Misc.PostbarDashboard/Views/Ap/Orders.cshtml");
        }
        ...
        public virtual IActionResult OrdersPaged(int pageIndex, int pageSize)
        {
            ...
            return View("~/Plugins/Nop.Plugin.Misc.PostbarDashboard/Views/Ap/_OrdersPaged.cshtml", orderModel);
        }
        [HttpPost]
        ...
        public virtual IActionResult CustomerInfo()
        {
            ...
            return View("~/Plugins/Nop.Plugin.Misc.PostbarDashboard/Views/Ap/CustomerInfo.cshtml", model);
        }
        ...
        public virtual IActionResult ChangePass()
        {
            ...
            return View("~/Plugins/Nop.Plugin.Misc.PostbarDashboard/Views/Ap/ChangePass.cshtml");
        }
        ...
        public virtual IActionResult PostalAddress()
        {
            ...
            return View("~/Plugins/Nop.Plugin.Misc.PostbarDashboard/Views/Ap/PostalAddress.cshtml", model);
        }
        ...
        public ActionResult Configure()
        {
            ...
            return View("~/Plugins/Nop.Plugin.Misc.PostbarDashboard/Views/Ap/Configure.cshtml", model);
        }
        ...
        public virtual IActionResult support()
        {
            if (!_workContext.CurrentCustomer.IsRegistered())
                return Challenge();
            return View("~/Plugins/Nop.Plugin.Misc.PostbarDashboard/Views/Ap/support.cshtml");
        }
        ...
        public virtual IActionResult supportPaged(int pageIndex, int pageSize)
        {
            ...
            return View("~/Plugins/Nop.Plugin.Misc.PostbarDashboard/Views/Ap/_supportPaged.cshtml", SupportModel);
        }
        ...
        {
            return View("~/Plugins/Nop.Plugin.Misc.PostbarDashboard/Views/Ap/AddSupport.cshtml");
        }
        ...
        public virtual IActionResult DetailSupport(int id)
        {
            ...
            return View("~/Plugins/Nop.Plugin.Misc.PostbarDashboard/Views/Ap/DetailSupport.cshtml", model);
        }
        ...
        {
            ViewBag.UrlFil = url;
            return PartialView("~/Plugins/Nop.Plugin.Misc.PostbarDashboard/Views/Ap/ReadFilePdf.cshtml");
        }
        ...
        public virtual IActionResult FAQ()
        {
            ...
            return View("~/Plugins/Nop.Plugin.Misc.PostbarDashboard/Views/Ap/ListFAQ.cshtml", model);
        }
        ...
        public IActionResult Services()
        {
            ...
            return View("~/Plugins/Nop.Plugin.Misc.PostbarDashboard/Views/Ap/Services.cshtml", model);
        }
        ...
        {
            return View("~/Plugins/Nop.Plugin.Misc.PostbarDashboard/Views/Ap/AddRequestCOD.cshtml");
        }
    }
}
